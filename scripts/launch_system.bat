...
:: =============================================================================
:: launch_system.bat - Unified JTAG System Loader (PL Bitstream + PS Firmware)
::
:: Modes:
::   1. Default (PL + PS):  .\run_all.bat
::   2. Custom Bitstream:   .\run_all.bat --bit path\to\file.bit
::   3. PS Only (Fast):     .\run_all.bat --ps-only   (or .\run.bat)
:: =============================================================================
...
set "TCL_SCRIPT=%SCRIPT_DIR%launch_system.tcl"
